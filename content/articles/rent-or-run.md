...
thoughts:
  ...
  - "Prices in this post will be wrong by Christmas, but the reasoning should hold up longer."
---

Every team using AI ends up asking this. You can pay per {{< term "token" >}}token{{< /term >}} to use someone else's model through an API. Or you can download an {{< term "open-weights" >}}open-weights{{< /term >}} model and run it yourself, on {{< term "gpu" >}}GPUs{{< /term >}} you rent or buy.

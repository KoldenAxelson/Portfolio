...
In March 2023, a developer named Georgi Gerganov published [llama.cpp](https://github.com/ggml-org/llama.cpp/commit/26c084662903ddaca19bef982831bfb0856e8257): a plain C/C++ program whose stated goal was to run Meta's LLaMA models at 4 bits on a MacBook, using the CPU alone. It worked. {{< term "inference" >}}Running a model{{< /term >}} stopped needing a data center, or even a graphics card. It's the digit reader from the last post running in your browser, just a few hundred thousand times bigger.
...
Everything so far starts with a precise model and rounds it off. Microsoft Research asked the opposite question: what if the model never had precision to lose? {{< term "quantization-aware-training" >}}Train it with the rounding already in place{{< /term >}}, and let it learn weights that work on the coarsest ruler possible.
...
*As of September 2026.* {{< term "int8" >}}8-bit{{< /term >}} is the safe default: about half the memory of {{< term "fp16" >}}FP16{{< /term >}} with no quality lost worth worrying about. {{< term "int4" >}}4-bit{{< /term >}} is the everyday sweet spot. It's how most people run open models on their own hardware, through {{< term "post-training-quantization" >}}post-training{{< /term >}} recipes and {{< term "gguf" >}}GGUF{{< /term >}} files, and how new open models increasingly ship, in {{< term "fp4" >}}FP4{{< /term >}} formats the latest chips run natively. The biggest labs train in {{< term "fp8" >}}FP8{{< /term >}}, and 4-bit training has worked at 12 billion weights. {{< term "1-bit-llm" >}}1-bit models{{< /term >}} are real and downloadable, but small. If you're running a model yourself today, 4-bit is the place to start.
...
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">Phones</span><span class="mli-cite-num">01 / 16</span></div><h3 class="mli-cite-title"><a href="https://arxiv.org/abs/1510.00149">Deep Compression: Compressing Deep Neural Networks with Pruning, Trained Quantization and Huffman Coding</a></h3><div class="mli-cite-meta">Han, Mao &amp; Dally · ICLR 2016</div><p class="mli-cite-note">Pruning plus rounding to about 5 bits: AlexNet from 240 MB to 6.9 MB with no accuracy loss. Where the modern story starts.</p></article>
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">Phones</span><span class="mli-cite-num">02 / 16</span></div><h3 class="mli-cite-title"><a href="https://arxiv.org/abs/1712.05877">Quantization and Training of Neural Networks for Efficient Integer-Arithmetic-Only Inference</a></h3><div class="mli-cite-meta">Jacob et al. · Google · CVPR 2018</div><p class="mli-cite-note">8-bit integers plus a shared scale, run on phone CPUs. The scheme TensorFlow Lite adopted.</p></article>
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">8-bit</span><span class="mli-cite-num">03 / 16</span></div><h3 class="mli-cite-title"><a href="https://arxiv.org/abs/2208.07339">LLM.int8(): 8-bit Matrix Multiplication for Transformers at Scale</a></h3><div class="mli-cite-meta">Dettmers et al. · NeurIPS 2022</div><p class="mli-cite-note">Found the outliers that break naive rounding in large models, and kept them in 16-bit. 175B in 8-bit, no degradation.</p></article>
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">8-bit</span><span class="mli-cite-num">04 / 16</span></div><h3 class="mli-cite-title"><a href="https://arxiv.org/abs/2211.10438">SmoothQuant: Accurate and Efficient Post-Training Quantization for Large Language Models</a></h3><div class="mli-cite-meta">Xiao et al. · ICML 2023</div><p class="mli-cite-note">Moves the hard-to-round part from the running numbers onto the weights, so both fit in 8 bits: up to 1.56× faster, half the memory.</p></article>
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">4-bit</span><span class="mli-cite-num">05 / 16</span></div><h3 class="mli-cite-title"><a href="https://arxiv.org/abs/2210.17323">GPTQ: Accurate Post-Training Quantization for Generative Pre-trained Transformers</a></h3><div class="mli-cite-meta">Frantar et al. · ICLR 2023</div><p class="mli-cite-note">Rounds weights one at a time and corrects for each error. 175B models to 3–4 bits in about four GPU hours.</p></article>
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">4-bit</span><span class="mli-cite-num">06 / 16</span></div><h3 class="mli-cite-title"><a href="https://arxiv.org/abs/2306.00978">AWQ: Activation-aware Weight Quantization for LLM Compression and Acceleration</a></h3><div class="mli-cite-meta">Lin et al. · MLSys 2024, Best Paper</div><p class="mli-cite-note">Protect the 1% of weights that matter most and 4-bit keeps its accuracy.</p></article>
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">Local</span><span class="mli-cite-num">07 / 16</span></div><h3 class="mli-cite-title"><a href="https://github.com/ggml-org/llama.cpp">llama.cpp</a></h3><div class="mli-cite-meta">Georgi Gerganov &amp; contributors · 2023–</div><p class="mli-cite-note">The C/C++ engine that put 4-bit language models on laptops, and home of the GGUF file format.</p></article>
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">Fine-tuning</span><span class="mli-cite-num">08 / 16</span></div><h3 class="mli-cite-title"><a href="https://arxiv.org/abs/2305.14314">QLoRA: Efficient Finetuning of Quantized LLMs</a></h3><div class="mli-cite-meta">Dettmers et al. · NeurIPS 2023</div><p class="mli-cite-note">Freeze the model in 4-bit, train a small add-on. A 65B model fine-tuned on a single 48 GB GPU.</p></article>
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">Hardware</span><span class="mli-cite-num">09 / 16</span></div><h3 class="mli-cite-title"><a href="https://arxiv.org/abs/2209.05433">FP8 Formats for Deep Learning</a></h3><div class="mli-cite-meta">Micikevicius et al. · NVIDIA, Arm &amp; Intel · 2022</div><p class="mli-cite-note">The two 8-bit floating-point formats now built into data-center GPUs, shown to train as well as 16-bit.</p></article>
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">Hardware</span><span class="mli-cite-num">10 / 16</span></div><h3 class="mli-cite-title"><a href="https://www.opencompute.org/blog/amd-arm-intel-meta-microsoft-nvidia-and-qualcomm-standardize-next-generation-narrow-precision-data-formats-for-ai">Microscaling (MX) formats standard</a></h3><div class="mli-cite-meta">Open Compute Project · 2023</div><p class="mli-cite-note">Seven companies agree on block-scaled formats down to 4 bits, including the MXFP4 that gpt-oss ships in.</p></article>
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">Hardware</span><span class="mli-cite-num">11 / 16</span></div><h3 class="mli-cite-title"><a href="https://developer.nvidia.com/blog/introducing-nvfp4-for-efficient-and-accurate-low-precision-inference/">Introducing NVFP4 for Efficient and Accurate Low-Precision Inference</a></h3><div class="mli-cite-meta">NVIDIA Technical Blog · 2025</div><p class="mli-cite-note">A clear explainer of 4-bit floating point with fine-grained scales, and what it costs in accuracy.</p></article>
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">Born small</span><span class="mli-cite-num">12 / 16</span></div><h3 class="mli-cite-title"><a href="https://arxiv.org/abs/2509.25149">Pretraining Large Language Models with NVFP4</a></h3><div class="mli-cite-meta">NVIDIA · 2025</div><p class="mli-cite-note">A 12B model trained on 10 trillion tokens in 4-bit, matching the 8-bit baseline.</p></article>
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">1-bit</span><span class="mli-cite-num">13 / 16</span></div><h3 class="mli-cite-title"><a href="http://www.jmlr.org/papers/volume26/24-2050/24-2050.pdf">BitNet: 1-bit Pre-training for Large Language Models</a></h3><div class="mli-cite-meta">Wang, Ma et al. · JMLR 2025</div><p class="mli-cite-note">The journal version of the BitNet line, covering both the 1-bit and 1.58-bit models in one place.</p></article>
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">1-bit</span><span class="mli-cite-num">14 / 16</span></div><h3 class="mli-cite-title"><a href="https://arxiv.org/abs/2402.17764">The Era of 1-bit LLMs: All Large Language Models are in 1.58 Bits</a></h3><div class="mli-cite-meta">Ma et al. · Microsoft Research · 2024</div><p class="mli-cite-note">Weights of −1, 0 and +1, trained in, matching full precision at the same size and data.</p></article>
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">1-bit</span><span class="mli-cite-num">15 / 16</span></div><h3 class="mli-cite-title"><a href="https://thejeshgn.com/2026/08/25/exploring-1-bit-llms/">Exploring 1-bit LLMs</a></h3><div class="mli-cite-meta">Thejesh GN · 2026</div><p class="mli-cite-note">A hands-on account of running 1-bit models locally, with the storage math spelled out.</p></article>
<article class="mli-cite-card"><div class="mli-cite-top"><span class="mli-cite-tag">Practice</span><span class="mli-cite-num">16 / 16</span></div><h3 class="mli-cite-title"><a href="https://vrlatech.com/llm-quantization-explained-int4-int8-fp8-awq-and-gptq-in-2026/">LLM Quantization Explained: INT4, INT8, FP8, AWQ and GPTQ in 2026</a></h3><div class="mli-cite-meta">VRLA Tech · 2026</div><p class="mli-cite-note">A practical buyer's-eye overview of today's formats and memory math. It's from a hardware vendor, so take its quality percentages as rough.</p></article>
</div></div>

...
4. **Vue only where it earns its keep.** The project filter on `/work` is a Vue island. It
...
4. Run `bash setup.sh` for the bits that need to happen on your machine.
5. Read `HUMAN.md` for the bits that only you can do.

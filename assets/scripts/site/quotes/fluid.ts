...
export function initQuotesFluid(): void {
  ...
  // yet — scripts/site/main.ts defers its init into requestIdleCallback to keep the LCP
...
// Its own entry point, re-run on hx-boost swaps the same way scripts/site/main.ts is —
